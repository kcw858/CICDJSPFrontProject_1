	...
	<head>
		...
		function commons(page)
		{
			...
			$.ajax({
				...
				traditional:true, //자바에서 배열을 받을 때 사용
		...
		function jsonView(json)
		{
			...
			json.forEach((food)=>{
				html+='<div class="col-sm-3">'
					+'<a href="#">'
					+'<div class="thumbnail">'
					+'<img src="'+food.poster+'" style="width:250px;height:130px;object-fit:fill">'
					+'</div>'
					+'<p>'+food.name+'</P>'
					+'</a>'
					+'</div>'
			...
			<%-- 
			  	<c:forEach var="vo" items="${list}">
			  		<div class="col-sm-3">
			  			<a href="#">
			  				<div class="thumbnail">
			  					<img src="${vo.poster}" style="width: 250px;height: 130px;object-fit:fill">
			  				</div>
			  				<p>${vo.name}</p>
			  			</a>
			  		</div>
